...
#declare wire =  union{cylinder{<0,1.49>,<0,3.68>,0.03} texture {
        pigment {color rgb <1, 1, 1>}
        finish {ambient .8 diffuse .6}
      }}
#declare horse = union{object{bottom_full} object{glass_full} object{wire}}  
#declare horse_gold = union{object{bottom_gold} object{glass_full} object{wire}}
#declare horse_silver = union{object{bottom_silver} object{glass_full} object{wire}}
